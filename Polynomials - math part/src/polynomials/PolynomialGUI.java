...
public class PolynomialGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .add(jPanel4Layout.createSequentialGroup()
                ...
                .add(18, 18, 18)
                .add(mpEqualButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 55, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
            ...
            .add(jPanel5Layout.createSequentialGroup()
                .add(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel5Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(rpEqualButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 49, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(jPanel5Layout.createSequentialGroup()
                        .add(218, 218, 218)
                        .add(jLabel3))
                    .add(jPanel5Layout.createSequentialGroup()
                        .add(61, 61, 61)
                        .add(rpOutput, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 445, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
    ...
    private void graphMainActionPerformed(java.awt.event.ActionEvent evt) {                                          
        if (clearGraph == false) {
            clearGraph(pMain);
            graphMain.setText("Graph Main Polynomial");
            clearGraph = true;
    ...
    private void mpEqualButtonActionPerformed(java.awt.event.ActionEvent evt) {                                              
    ...
    //get derivative
    private void derivativeButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        derivative = pMain.differentiate();
        derivativeOutput.setText("The derivative of this polynomial is " + derivative.print());
    }                                                

    //graphs derivative
    private void derivativeGraphActionPerformed(java.awt.event.ActionEvent evt) {                                                
        derivative = pMain.differentiate();
    ...
    //graphs inverse
    private void inverseGraphActionPerformed(java.awt.event.ActionEvent evt) {                                             
        graphingInverse = true;
        graph(pMain);
        graphingInverse = false;
    }                                            

    private void otherInputActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    private void mainPolynomialInputActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        // TODO add your handling code here:
    }                                                   
    ...
    private void getValueActionPerformed(java.awt.event.ActionEvent evt) {                                         
        getY(pMain);
    }                                        
    ...
    private void graphTangentLineActionPerformed(java.awt.event.ActionEvent evt) {                                                 
    ...
    private void rpEqualButtonActionPerformed(java.awt.event.ActionEvent evt) {                                              
